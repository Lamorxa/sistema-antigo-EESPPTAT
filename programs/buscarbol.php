<?php
    ...
    $SQLquery = "select m.idMov as id, m.nroRecibo as nro, p.nombres AS nombres, m.tipo as tipo, m.fecha as fecha, m.importe as importe, t.nombreTupa as tupas, m.concepto as concepto, c.Clasif as clasif from movimiento m, persona p, tupa t, clasificador c where m.nroRecibo='$var_boleta' and m.idPersona=p.idPersona and m.tupa=t.idTupa and t.idClasif=c.idClasif";
