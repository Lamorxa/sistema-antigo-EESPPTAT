<?php
  ...
  //  $total_registros = mysql_num_rows($SQLresult);
    ...
    while($SQLrow = mysql_fetch_array($SQLresult)){
        ...
        $SQLquerys = "select m.cantidad,m.importe, t.nombreTupa as tupas,m.concepto from movimiento m, tupa t where  m.tupa=t.idTupa and m.nroRecibo='$recibo' order by m.nroRecibo desc";
